            ...
            <div class="row">
                <div  class="col-lg-12">
                    <div class="card">
                        ...
                        <form id="form-horizontal" action="{{ url('/tab/'.$tab->id.'/option/edit/'.$option->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-10">
                                        <label>
                                            <img class="page-feature-icon" src="{{ $option->icon }}" old-src="{{ $option->icon }}" style="max-width: 100px">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-10">
                                        <input type="text" name="name" placeholder="Name" class="form-control" value="{{ $option->name }}">
                                    </div>
                                </div>
...
//                    },
                    name: {
                        required: true,
                        remote: {
                            url: "{{ url('option/validate/name/'.$option->id) }}",
                            type: "post",
                            headers: {
